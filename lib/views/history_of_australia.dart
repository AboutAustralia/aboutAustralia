...
class HistoryOfAustralia extends StatelessWidget {
    ...
    return Padding(
      ...
      child: Container(
        ...
        child: Text(
          cont,
          textAlign: TextAlign.right,
          style: AppTypography.bodyNormal2.copyWith(
  ...
  StickyHeaderBuilder scroll(
      String img, String title, String desc, String cont, Color colour) {
